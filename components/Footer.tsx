    ...
    <footer className="bg-charcoal text-off-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <Link href="https://www.instagram.com/lets_learn_english_with_sarah?utm_source=qr&igsh=MXI3aGRwc3BnZmdpMQ==" target="_blank" rel="noopener noreferrer" className="hover:text-teal transition-colors">
              ...
              <Link href="https://www.tiktok.com/@sarah.shamshad0?_r=1&_t=ZS-91gvpX9YXSR" target="_blank" rel="noopener noreferrer" className="hover:text-teal transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/gallery" className="text-neutral-gray hover:text-teal transition-colors">Gallery</Link></li>
        ...
        <div className="border-t border-neutral-gray/20 mt-8 pt-8 text-center text-neutral-gray">
          <p>&copy; {currentYear} --This site is Developed by --Ahmad Qureshi-- ahmadfreed7886@gmail.com</p>
        </div>
      </div>
    </footer>
  );
